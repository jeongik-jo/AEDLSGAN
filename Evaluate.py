...
@tf.function
def _get_batch_results(discriminator: kr.Model, generator: kr.Model, latent_scale_vector, data):
...
def evaluate(discriminator: kr.Model, generator: kr.Model, latent_var_trace: tf.Tensor, test_dataset: tf.data.Dataset):
    ...
    for data in test_dataset:
        batch_results = _get_batch_results(discriminator, generator, latent_scale_vector, data)
